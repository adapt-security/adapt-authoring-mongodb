...
class MongoDBModule extends DataStore {
  ...
  */
  ...
  create(data) {
    return new Promise((resolve, reject) => {
      try {
        this.formatInputData(false, null, true, data);
      } catch(e) {
        return reject(e);
      }
      if(!data) {
      ...
      // this.formatError(e, this.app.lang.t('error.createdocs'));
      resolve();
    });
  }
  /** @override*/
  ...
  formatInputData(expectQuery, query, expectData, data) {
    if(expectData && !data) {
      throw this.formatError(this.app.lang.t('error.noupdatedata'), 'error.updatedocs', Responder.StatusCodes.Error.User);
    }
    if(!expectQuery) {
      return;
    }
    try {
      return { query: MongoDBModule.formatQuery(data) };
    } catch(e) {
      throw this.formatError(e, this.app.lang.t('error.updatedocs', Responder.StatusCodes.Error.User));
    }
  }
  /**
