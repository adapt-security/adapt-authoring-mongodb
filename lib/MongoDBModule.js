...
class MongoDBModule extends AbstractModule {
  ...
  async init() {
     ...
     * @type {external:mongodb~MongoClient}
     */
   ...
   * @return {external:mongodb~Collection}
   ...
   * @param {external:mongodb~CreateIndexesOptions} opyions Options to pass to the MongoDB driver
   * @return {Promise}
   ...
   * @param {String} collectionName The name of the MongoDB collection
   * @param {Object} data
   * @param {external:mongodb~InsertOneOptions} opyions Options to pass to the MongoDB driver
   ...
   * @param {String} collectionName The name of the MongoDB collection
   * @param {Object} query
   * @param {external:mongodb~FindOptions} opyions Options to pass to the MongoDB driver
   * @return {Promise} promise
   ...
   * @param {Object} query
   * @param {Object} data
   * @param {external:mongodb~FindOneAndUpdateOptions} opyions Options to pass to the MongoDB driver
   * @return {Promise} promise
   ...
   * @param {Object} query
   * @param {Object} data
   * @param {external:mongodb~FindOneAndReplaceOptions} opyions Options to pass to the MongoDB driver
   * @return {Promise} promise
   ...
   * @param {String} collectionName The name of the MongoDB collection
   * @param {Object} query
   * @param {external:mongodb~DeleteOptions} opyions Options to pass to the MongoDB driver
   * @return {Promise} promise
