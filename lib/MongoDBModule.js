...
class MongoDBModule extends AbstractModule {
   ...
   * @param {external:MongoDBCreateIndexesOptions} opyions Options to pass to the MongoDB driver
   * @return {Promise}
   ...
   * @param {String} collectionName The name of the MongoDB collection
   * @param {Object} data
   * @param {external:MongoDBInsertOneOptions} opyions Options to pass to the MongoDB driver
   ...
   * @param {String} collectionName The name of the MongoDB collection
   * @param {Object} query
   * @param {external:MongoDBFindOptions} opyions Options to pass to the MongoDB driver
   * @return {Promise} promise
   ...
   * @param {Object} query
   * @param {Object} data
   * @param {external:MongoDBFindOneAndUpdateOptions} opyions Options to pass to the MongoDB driver
   * @return {Promise} promise
   ...
   * @param {Object} query
   * @param {Object} data
   * @param {external:MongoDBFindOneAndReplaceOptions} opyions Options to pass to the MongoDB driver
   * @return {Promise} promise
   ...
   * @param {String} collectionName The name of the MongoDB collection
   * @param {Object} query
   * @param {external:MongoDBDeleteOptions} opyions Options to pass to the MongoDB driver
   * @return {Promise} promise
