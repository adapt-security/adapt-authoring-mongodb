...
class MongoDBModule extends AbstractModule {
  ...
  */
  static formatQuery(query) {
    if(!query || !(query instanceof DataQuery)) {
      const e = new Error(this.app.lang.t('error.expecteddataquery'));
  ...
  */
  async retrieve(query) {
    try {
      ...
      if(query.fieldsMatching._id && !results.length) {
        const e = new Error(this.app.lang.t('error.itemnotfound', { type: query.type }));
        e.statusCode = ErrorCodes.Missing;
        throw e;
      }
      return results;
    } catch(e) {
  ...
  */
  async update(query, data) {
    ...
    if(!results.modifiedCount) {
      ...
      throw this.formatError('updatedocs', e, Responder.StatusCodes.Error.Missing);
    }
  }
  /**
  ...
  */
  async delete(query) {
    ...
    if(!results.deletedCount) {
      const e = { message: this.app.lang.t('error.nomatchingdocs') };
      throw this.formatError('deletedocs', e, Responder.StatusCodes.Error.Missing);
    }
  }
  /**
  ...
  */
  async validateData(data) {
    ...
    await jsonschema.validate(data.type, data);
  }
  /**
