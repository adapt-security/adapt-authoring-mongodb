...
class MongoModel {
  ...
  * @param {{name: String, schema: Object, connection: mongoose~Connection}} data Data to define the model
  */
  constructor(data) {
    /**
    * Name of the model
    ...
    */
    this.compiled = data.connection.model(this.name, new mongoose.Schema(data.schema, {
    ...
    */
    this.addSchemaPlugin = (plugin) => this.compiled.schema.plugin(plugin);
    /**
    ...
    */
    this.extendSchema = (schema) => this.compiled.schema.add(schema);
    /**
    ...
    */
    this.pre = (method, callback) => this.compiled.schema.pre(method, callback);
    /**
    ...
    * @param {Function} callback callback
    */
    this.post = (method, callback) => this.compiled.schema.post(method, callback);
  }
}
